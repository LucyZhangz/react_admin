...
import {getDepartment,editDepartment} from '../../../api/Organization/department'
...
// }
  const onFinish = (values) => {
    ...
    // }
    values.id = props.DepartmentData.id
    editdepartment(values)
  };
  //   console.log(props);
  function CloseModal() {
    props.sethandleEdit(false);
    // location.reload()
...
async function editdepartment(data){
  ...
  useEffect(()=>{
    fromref.current.setFieldsValue({
        ...
        pidName:props.DepartmentData.pidName,
        managerName:props.DepartmentData.managerName,
